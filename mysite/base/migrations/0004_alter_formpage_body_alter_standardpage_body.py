...
class Migration(migrations.Migration):
    dependencies = [
        ("base", "0003_alter_formpage_body_alter_standardpage_body"),
    ]
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    (
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ("phone", wagtail.blocks.CharBlock()),
                                ("whatsapp", wagtail.blocks.CharBlock()),
                                ("email", wagtail.blocks.EmailBlock()),
                                ("address", wagtail.blocks.TextBlock()),
                                ("website", wagtail.blocks.URLBlock()),
                            ]
                        ),
                    ),
                ],
